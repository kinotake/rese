    ...
    <div class="middle_contents">
        <div class="content_left">
            <div class="question_contents">
                <p class="question">"{{$shopData->name}}"への評価を変更されますか？</p>
            </div>
            <p>以前のあなたの投稿（最終更新日時{{$postData->updated_at}}）</p>
            <div class="post_content">
                ...
                <div class="star_contents">
                    @for ($count = 1; $count <= $postData->score; $count++)
                        <p class="star">★</p>
                    @endfor
                    @for ($count = 1; $count <= 5-$postData->score; $count++)
                        <p class="star_shadow">★</p>
                    @endfor
                </div>
                <div class="comment_content">
                    <p class="font">{{$postData->comment}}</p>
                </div>
                <img src="{{ asset($postData->getImage()) }}" class="shop_photo" alt="この投稿に画像はありません。">
            </div>
        </div>
